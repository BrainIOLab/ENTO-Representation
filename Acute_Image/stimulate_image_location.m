...
%% 设置实验参数
image_config.experiment = 'ento_exp1_20250325_loc_2';                                   %实验名称
...
image_config.xcenter = [576:448:3264];                                                  %x坐标，中心点
image_config.ycenter = [512:224:1408];                                                  %y坐标，中心点
image_config.stimulatetime = 500;                                                       %ms，每个刺激持续的时间。
image_config.darktime = 1000;                                                           %ms，每个休息持续的时间。
...
[image_config.classname,image_config.classdata,image_config.stimulateorder,...          %index是y,x
    image_config.indexs] = s_order_imglocscale(image_config);
...
s_exp_imglocscale(image_config,w);                                                      %播放刺激图像
